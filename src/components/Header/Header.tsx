                    ...
                    <StyledHeaderInner>
                        ...
                        <StyledHeaderSocialMedia>
                            <StyledHeaderSocialItem>
                                <StyledHeaderSocialLink href="https://facebook.com" target="blank">
                                    <StyledHeaderSocialLogo width={10}
                                        src={facebookLogo}
                                        height={20} alt="Our Facebook" />
                                </StyledHeaderSocialLink>
                            </StyledHeaderSocialItem>
                            <StyledHeaderSocialItem>
                                <StyledHeaderSocialLink href="https://twitter.com" target="blank">
                                    <StyledHeaderSocialLogo width={10}
                                        src={twitterLogo}
                                        height={20} alt="Our Twitter" />
                                </StyledHeaderSocialLink>
                            </StyledHeaderSocialItem>
                            <StyledHeaderSocialItem>
                                <StyledHeaderSocialLink href="https://linkedin.com" target="blank">
                                    <StyledHeaderSocialLogo width={10}
                                        src={linkedinLogo}
                                        height={20} alt="Our LinkedIn" />
                                </StyledHeaderSocialLink>
                            </StyledHeaderSocialItem>
                        </StyledHeaderSocialMedia>
