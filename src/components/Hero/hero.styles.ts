...
const StyledHero = styled(motion.section).attrs({
    className:
        "relative py-16 pt-[480px] pb-[93px] bg-white before:absolute before:top-0  before:left-1/2 before:w-[min(375px,100%)] before:h-[451px] before:bg-no-repeat before:-translate-x-1/2 lg:before:top-[10%] lg:py-[127px] lg:before:w-[540px] lg:before:h-[450px] lg:before:left-[75%] lg:before:bg-cover lg:before:bg-center lg:before:rounded-xl",
})<StyledHeroTypes>`
